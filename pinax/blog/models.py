...
class Post(models.Model):
    ...
    author = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="posts", verbose_name=_("Author"), on_delete=None)
    ...
    image_set = models.ForeignKey(ImageSet, related_name="blog_posts", on_delete=None)
...
class Revision(models.Model):
    ...
    post = models.ForeignKey(Post, related_name="revisions", verbose_name=_("Post"), on_delete=None)
    ...
    author = models.ForeignKey(settings.AUTH_USER_MODEL, related_name="revisions", verbose_name=_("Author"), on_delete=None)
...
class ReviewComment(models.Model):
    ...
    post = models.ForeignKey(Post, related_name="review_comments", verbose_name=_("Post"), on_delete=None)
