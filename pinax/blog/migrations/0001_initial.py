    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(related_name='posts', to=settings.AUTH_USER_MODEL, on_delete=None)),
                ('primary_image', models.ForeignKey(related_name='+', blank=True, to='blog.Image', null=True, on_delete=None)),
            ],
            options={
                'ordering': ('-published',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(related_name='review_comments', to='blog.Post', on_delete=None)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('view_count', models.IntegerField(default=0, editable=False)),
                ('author', models.ForeignKey(related_name='revisions', to=settings.AUTH_USER_MODEL, on_delete=None)),
                ('post', models.ForeignKey(related_name='revisions', to='blog.Post', on_delete=None)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='image',
            name='post',
            field=models.ForeignKey(related_name='images', to='blog.Post', on_delete=None),
